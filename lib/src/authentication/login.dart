...
import 'package:pwanistore/main.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  final String _email = 'mariamabubakar706@gmail.com';
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color.fromARGB(255, 253, 82, 82),
                        ...
                        children: [
                          TextSpan(
                            ...
                            style: TextStyle(
                              fontSize: 16.0,
                              fontWeight: FontWeight.bold,
                              color: Color.fromARGB(255, 253, 82, 82),
                            ),
                            recognizer: TapGestureRecognizer()
                              ..onTap = () {
                                Navigator.push(
